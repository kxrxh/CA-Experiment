...
class MicroProgramMemory:
    ...
    _memory: List[List[Signal]] = [
        # 0: Instruction fetch
        [Signal.SEL_ONE_INC, Signal.SEL_PC_INC, Signal.LATCH_PC,
        ...
        [Signal.SEL_SRC_CU, Signal.LATCH_REG15,
            Signal.SEL_MPC_INC, Signal.LATCH_MPC],
        [Signal.SEL_REG_L, Signal.SEL_R_REG15, Signal.ALU_ADD, Signal.SEL_SRC_ALU,
            Signal.LATCH_REG, Signal.SEL_MPC_ZERO, Signal.LATCH_MPC],
        ...
        [Signal.SEL_SRC_CU, Signal.LATCH_REG15,
            Signal.SEL_MPC_INC, Signal.LATCH_MPC],
        [Signal.SEL_REG_L, Signal.SEL_R_REG15, Signal.ALU_SUB, Signal.SEL_SRC_ALU,
            Signal.LATCH_REG, Signal.SEL_MPC_ZERO, Signal.LATCH_MPC],

        # 11: Mul no-flag
        [Signal.SEL_REG_L, Signal.SEL_REG_R, Signal.ALU_MUL, Signal.SEL_SRC_ALU,
            Signal.LATCH_REG, Signal.SEL_MPC_ZERO, Signal.LATCH_MPC],

        # 12: Mul with flag
        [Signal.SEL_SRC_CU, Signal.LATCH_REG15,
            Signal.SEL_MPC_INC, Signal.LATCH_MPC],
        [Signal.SEL_REG_L, Signal.SEL_R_REG15, Signal.ALU_MUL, Signal.SEL_SRC_ALU,
            Signal.LATCH_REG, Signal.SEL_MPC_ZERO, Signal.LATCH_MPC],

        # 14: And with no-flag
        [Signal.SEL_REG_L, Signal.SEL_REG_R, Signal.ALU_AND, Signal.SEL_SRC_ALU,
            Signal.LATCH_REG, Signal.SEL_MPC_ZERO, Signal.LATCH_MPC],

        # 15: And with flag
        [Signal.SEL_SRC_CU, Signal.LATCH_REG15,
            Signal.SEL_MPC_INC, Signal.LATCH_MPC],
        [Signal.SEL_REG_L, Signal.SEL_R_REG15, Signal.ALU_AND, Signal.SEL_SRC_ALU,
            Signal.LATCH_REG, Signal.SEL_MPC_ZERO, Signal.LATCH_MPC],

        # 17: lw
        [Signal.SEL_SRC_CU,
         Signal.SEL_REG_L, Signal.LATCH_READ_MEM, Signal.SEL_MPC_INC, Signal.LATCH_MPC],
        [Signal.SEL_SRC_MEM, Signal.LATCH_REG,
            Signal.SEL_MPC_ZERO, Signal.LATCH_MPC],

        # 19: sw
        [Signal.SEL_REG_L, Signal.SEL_REG_R,
         Signal.LATCH_WRITE_MEM, Signal.SEL_MPC_ZERO, Signal.LATCH_MPC],
